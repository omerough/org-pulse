    ...
    <div class="flex flex-wrap gap-2 mb-4">
      <div class="relative w-full max-w-[280px]">
        ...
        <input
          ...
          class="pl-8 w-full h-9 border border-gray-300 dark:border-gray-600 rounded-md text-sm bg-white dark:bg-gray-800 dark:text-gray-300 placeholder-gray-400 dark:placeholder-gray-500"
        />
      </div>
      <select
        :value="filter"
